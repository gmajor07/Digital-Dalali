...
class MoreImagesSearch extends StatefulWidget {
  final String roomId;
  final List<String> imageURLs; // Add the imageURLs list here

  const MoreImagesSearch(
      {super.key, required this.roomId, required this.imageURLs});

  @override
  _MoreImagesSearchState createState() => _MoreImagesSearchState();
}

class _MoreImagesSearchState extends State<MoreImagesSearch> {
